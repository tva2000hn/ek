    ...
    */
    ...
    for (var i = 0; i < 5 * multiplier; i++) {
        if (i < 4 * multiplier) {
            ...
            this.drawPile.push(new Card(this.generateRandomID(), 'beard', $.CARD.REGULAR, 6));
            this.drawPile.push(new Card(this.generateRandomID(), 'rainbow', $.CARD.REGULAR, 7));
            this.drawPile.push(new Card(this.generateRandomID(), 'hairy', $.CARD.REGULAR, 8));
        }
